...
def process_df():
    ...
    time.sleep(2)
    FM, AH = middle_process(imported,new_hire)
    time.sleep(2)

    final_one_month_orders = final_process(FM,new_hire,courier_demos)
    final_all_history_orders = final_process(AH,new_hire,courier_demos)
    time.sleep(2)
